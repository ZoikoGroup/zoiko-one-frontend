...
export default function DocumentsPage() {
  ...
  return (
    <SuperAdminShell>
      <PageHeader
        title="Documents"
        description="Manage employee documents including contracts, NDAs, ID proofs, and certifications."
      />

      <section className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        <KPICard title="Total Employees" value={loading ? "..." : total} icon={Users} />
        <KPICard title="Documents" value="—" icon={FileText} description="View per employee" />
      </section>

      <ReusableTable
        title="Employees"
        description="Select an employee to view and manage their documents."
        columns={columns}
        data={employees}

...
export default function WorkforceSettings() {
  ...
  return (
    <HRPage title="Workforce Planning" subtitle="Configure workforce planning module preferences">
      <SubNav />
      ...
      <div className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-sm text-gray-500 mt-1">Configure your workforce planning preferences</p>
          </div>
          <button
            onClick={handleSave}
        ...
        {activeTab === "notifications" && (
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between py-2">
                <span className="text-sm text-gray-700">Planning updates</span>
                <Toggle checked={settings.notifications.planningUpdates} onChange={(v) => updateNested("notifications", "planningUpdates", v)} />
              </div>
              <div className="flex items-center justify-between py-2">
                <span className="text-sm text-gray-700">Report notifications</span>
                <Toggle checked={settings.notifications.reportNotifications} onChange={(v) => updateNested("notifications", "reportNotifications", v)} />
              </div>
            </div>
          </div>
        )}
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6 space-y-4">
            ...
            <div>
              ...
              <select
                ...
                className="w-full max-w-xs px-3 py-2 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-teal-500"
              >

...
export type CandidateStage = "APPLIED" | "SCREENING" | "TECHNICAL_INTERVIEW" | "HR_INTERVIEW" | "SELECTED" | "REJECTED";
...
const mockJobs: JobOpening[] = [
  { id: "job-001", title: "Senior Frontend Developer", department: "Engineering", location: "Remote", employmentType: "FULL_TIME", openPositions: 2, status: "OPEN", createdDate: "2026-05-01", description: "Build and maintain frontend applications.", requirements: "5+ years React experience", salaryMin: 120000, salaryMax: 160000 },
  { id: "job-002", title: "Backend Engineer", department: "Engineering", location: "New York, NY", employmentType: "FULL_TIME", openPositions: 1, status: "OPEN", createdDate: "2026-05-05", description: "Design and build scalable APIs.", requirements: "3+ years Node.js experience", salaryMin: 110000, salaryMax: 150000 },
  { id: "job-003", title: "HR Manager", department: "Human Resources", location: "San Francisco, CA", employmentType: "FULL_TIME", openPositions: 1, status: "OPEN", createdDate: "2026-05-10", description: "Oversee HR operations.", requirements: "7+ years HR experience", salaryMin: 90000, salaryMax: 120000 },
  { id: "job-004", title: "DevOps Engineer", department: "Engineering", location: "Remote", employmentType: "CONTRACT", openPositions: 1, status: "DRAFT", createdDate: "2026-05-15", description: "Manage cloud infrastructure.", requirements: "AWS, Kubernetes experience", salaryMin: 130000, salaryMax: 170000 },
  { id: "job-005", title: "Product Designer", department: "Design", location: "Austin, TX", employmentType: "FULL_TIME", openPositions: 1, status: "ON_HOLD", createdDate: "2026-04-20", description: "Design user-centric products.", requirements: "Figma, UX research skills", salaryMin: 100000, salaryMax: 140000 },
  { id: "job-006", title: "Data Analyst", department: "Data", location: "Chicago, IL", employmentType: "FULL_TIME", openPositions: 2, status: "OPEN", createdDate: "2026-05-18", description: "Analyze business data.", requirements: "SQL, Python, Tableau", salaryMin: 80000, salaryMax: 110000 },
  { id: "job-007", title: "Marketing Specialist", department: "Marketing", location: "Remote", employmentType: "PART_TIME", openPositions: 1, status: "CLOSED", createdDate: "2026-03-01", description: "Manage social media campaigns.", requirements: "3+ years marketing experience", salaryMin: 50000, salaryMax: 70000 },
  { id: "job-008", title: "QA Engineer", department: "Engineering", location: "Seattle, WA", employmentType: "FULL_TIME", openPositions: 1, status: "OPEN", createdDate: "2026-05-22", description: "Ensure product quality.", requirements: "Automation testing experience", salaryMin: 90000, salaryMax: 120000 },
];

const mockCandidates: Candidate[] = [
  { id: "can-001", name: "Alice Johnson", positionApplied: "Senior Frontend Developer", email: "alice@example.com", phone: "+1-555-0101", experience: 6, currentStage: "TECHNICAL_INTERVIEW", status: "ACTIVE", appliedDate: "2026-05-10", source: "LinkedIn", notes: "Strong React portfolio" },
  { id: "can-002", name: "Bob Smith", positionApplied: "Backend Engineer", email: "bob@example.com", phone: "+1-555-0102", experience: 4, currentStage: "HR_INTERVIEW", status: "ACTIVE", appliedDate: "2026-05-12", source: "Referral", notes: "Good system design skills" },
  { id: "can-003", name: "Carol Williams", positionApplied: "HR Manager", email: "carol@example.com", phone: "+1-555-0103", experience: 8, currentStage: "SELECTED", status: "ACTIVE", appliedDate: "2026-05-08", source: "Company Website", notes: "Excellent leadership experience" },
  { id: "can-004", name: "David Brown", positionApplied: "Senior Frontend Developer", email: "david@example.com", phone: "+1-555-0104", experience: 5, currentStage: "SCREENING", status: "ACTIVE", appliedDate: "2026-05-15", source: "Indeed", notes: "Needs assessment" },
  { id: "can-005", name: "Eve Davis", positionApplied: "Product Designer", email: "eve@example.com", phone: "+1-555-0105", experience: 3, currentStage: "REJECTED", status: "REJECTED", appliedDate: "2026-04-25", source: "Dribbble", notes: "Portfolio not aligned" },
  { id: "can-006", name: "Frank Miller", positionApplied: "DevOps Engineer", email: "frank@example.com", phone: "+1-555-0106", experience: 7, currentStage: "APPLIED", status: "ACTIVE", appliedDate: "2026-05-20", source: "LinkedIn", notes: "Strong AWS background" },
  { id: "can-007", name: "Grace Wilson", positionApplied: "Data Analyst", email: "grace@example.com", phone: "+1-555-0107", experience: 2, currentStage: "TECHNICAL_INTERVIEW", status: "ACTIVE", appliedDate: "2026-05-14", source: "University Recruiting", notes: "Recent grad, strong academics" },
  { id: "can-008", name: "Henry Taylor", positionApplied: "Marketing Specialist", email: "henry@example.com", phone: "+1-555-0108", experience: 4, currentStage: "HR_INTERVIEW", status: "ACTIVE", appliedDate: "2026-05-11", source: "Referral", notes: "Strong campaign portfolio" },
  { id: "can-009", name: "Ivy Anderson", positionApplied: "Backend Engineer", email: "ivy@example.com", phone: "+1-555-0109", experience: 3, currentStage: "REJECTED", status: "REJECTED", appliedDate: "2026-04-28", source: "Indeed", notes: "Technical gaps" },
  { id: "can-010", name: "Jack Thomas", positionApplied: "QA Engineer", email: "jack@example.com", phone: "+1-555-0110", experience: 5, currentStage: "APPLIED", status: "ACTIVE", appliedDate: "2026-05-22", source: "Company Website", notes: "" },
];

const mockInterviews: Interview[] = [
  { id: "int-001", candidateId: "can-001", candidateName: "Alice Johnson", position: "Senior Frontend Developer", interviewer: "Sarah Chen", date: "2026-05-20", time: "10:00", type: "Technical", status: "SCHEDULED", notes: "Focus on React and system design" },
  { id: "int-002", candidateId: "can-002", candidateName: "Bob Smith", position: "Backend Engineer", interviewer: "Mike Rodriguez", date: "2026-05-19", time: "14:00", type: "Technical", status: "COMPLETED", feedback: "Strong candidate, good problem solving", rating: 4 },
  { id: "int-003", candidateId: "can-003", candidateName: "Carol Williams", position: "HR Manager", interviewer: "Emily Davis", date: "2026-05-18", time: "11:00", type: "HR", status: "COMPLETED", feedback: "Excellent communication skills", rating: 5 },
  { id: "int-004", candidateId: "can-004", candidateName: "David Brown", position: "Senior Frontend Developer", interviewer: "Sarah Chen", date: "2026-05-22", time: "15:00", type: "Technical", status: "SCHEDULED", notes: "Take-home review" },
  { id: "int-005", candidateId: "can-001", candidateName: "Alice Johnson", position: "Senior Frontend Developer", interviewer: "Tom Wilson", date: "2026-05-17", time: "13:00", type: "HR", status: "COMPLETED", feedback: "Good cultural fit", rating: 4 },
  { id: "int-006", candidateId: "can-007", candidateName: "Grace Wilson", position: "Data Analyst", interviewer: "Lisa Park", date: "2026-05-23", time: "10:30", type: "Technical", status: "SCHEDULED", notes: "SQL and Python assessment" },
  { id: "int-007", candidateId: "can-008", candidateName: "Henry Taylor", position: "Marketing Specialist", interviewer: "James Brown", date: "2026-05-21", time: "11:00", type: "HR", status: "RESCHEDULED", notes: "Originally scheduled for May 18" },
  { id: "int-008", candidateId: "can-002", candidateName: "Bob Smith", position: "Backend Engineer", interviewer: "Emily Davis", date: "2026-05-16", time: "09:00", type: "HR", status: "CANCELLED", notes: "Conflict with candidate schedule" },
];

const mockOffers: Offer[] = [
  { id: "off-001", candidateId: "can-003", candidateName: "Carol Williams", position: "HR Manager", salary: 105000, currency: "USD", status: "ACCEPTED", sentDate: "2026-05-22", responseDate: "2026-05-25", notes: "Accepted verbally, offer letter signed" },
  { id: "off-002", candidateId: "can-002", candidateName: "Bob Smith", position: "Backend Engineer", salary: 130000, currency: "USD", status: "SENT", sentDate: "2026-05-23", notes: "Awaiting response" },
  { id: "off-003", candidateId: "can-001", candidateName: "Alice Johnson", position: "Senior Frontend Developer", salary: 145000, currency: "USD", status: "DRAFT", notes: "Preparing offer details" },
  { id: "off-004", candidateId: "can-005", candidateName: "Eve Davis", position: "Product Designer", salary: 95000, currency: "USD", status: "REJECTED", sentDate: "2026-05-01", responseDate: "2026-05-05", notes: "Candidate declined - accepted another offer" },
  { id: "off-005", candidateId: "can-009", candidateName: "Ivy Anderson", position: "Backend Engineer", salary: 110000, currency: "USD", status: "EXPIRED", sentDate: "2026-04-15", responseDate: "2026-05-01", notes: "Offer expired without response" },
  { id: "off-006", candidateId: "can-007", candidateName: "Grace Wilson", position: "Data Analyst", salary: 85000, currency: "USD", status: "DRAFT", notes: "Preparing junior offer" },
];

// ── Dashboard ──

export async function fetchRecruitmentDashboard(): Promise<{ data: RecruitmentDashboardStats }> {
  const stats: RecruitmentDashboardStats = {
    totalOpenPositions: mockJobs.filter((j) => j.status === "OPEN").length,
    ...
    offersSent: mockOffers.filter((o) => o.status === "SENT").length,
    offersAccepted: mockOffers.filter((o) => o.status === "ACCEPTED").length,
    hiringSuccessRate: mockOffers.length > 0
      ? Math.round((mockOffers.filter((o) => o.status === "ACCEPTED").length / mockOffers.length) * 100)
      : 0,
  };
  return { data: stats };
}
...
export async function fetchJobOpenings(filters?: { search?: string; status?: string; skip?: number; take?: number }): Promise<{ data: JobOpening[]; total: number; skip: number; take: number }> {
  let filtered = [...mockJobs];
  if (filters?.search) {
    const s = filters.search.toLowerCase();
    filtered = filtered.filter((j) => j.title.toLowerCase().includes(s) || j.department.toLowerCase().includes(s) || j.location.toLowerCase().includes(s));
  }
...
export async function createJobOpening(body: Partial<JobOpening> & { title: string; department: string }): Promise<{ data: JobOpening }> {
  const newJob: JobOpening = {
    ...
    openPositions: body.openPositions ?? 1,
...
export async function updateJobOpening(id: string, body: Partial<JobOpening>): Promise<{ data: JobOpening }> {
  const idx = mockJobs.findIndex((j) => j.id === id);
  if (idx === -1) throw new Error("Job opening not found");
  mockJobs[idx] = { ...mockJobs[idx], ...body };
  return { data: mockJobs[idx] };
}

export async function closeJobOpening(id: string): Promise<{ ok: boolean }> {
  const idx = mockJobs.findIndex((j) => j.id === id);
  if (idx === -1) throw new Error("Job opening not found");
  mockJobs[idx].status = "CLOSED";
  return { ok: true };
}

// ── Candidates ──

export async function fetchCandidates(filters?: { search?: string; stage?: string; status?: string; skip?: number; take?: number }): Promise<{ data: Candidate[]; total: number; skip: number; take: number }> {
  let filtered = [...mockCandidates];
  if (filters?.search) {
    const s = filters.search.toLowerCase();
    filtered = filtered.filter((c) => c.name.toLowerCase().includes(s) || c.positionApplied.toLowerCase().includes(s) || c.email.toLowerCase().includes(s));
  }
  if (filters?.stage) filtered = filtered.filter((c) => c.currentStage === filters.stage);
...
export async function updateCandidateStage(id: string, stage: CandidateStage): Promise<{ data: Candidate }> {
  const idx = mockCandidates.findIndex((c) => c.id === id);
  if (idx === -1) throw new Error("Candidate not found");
  mockCandidates[idx].currentStage = stage;
  if (stage === "REJECTED") mockCandidates[idx].status = "REJECTED";
  if (stage === "SELECTED") mockCandidates[idx].status = "SELECTED";
  return { data: mockCandidates[idx] };
}

// ── Interviews ──

export async function fetchInterviews(filters?: { search?: string; status?: string; skip?: number; take?: number }): Promise<{ data: Interview[]; total: number; skip: number; take: number }> {
  let filtered = [...mockInterviews];
  if (filters?.search) {
    const s = filters.search.toLowerCase();
    filtered = filtered.filter((i) => i.candidateName.toLowerCase().includes(s) || i.position.toLowerCase().includes(s) || i.interviewer.toLowerCase().includes(s));
  }
...
export async function createInterview(body: { candidateId: string; candidateName: string; position: string; interviewer: string; date: string; time: string; type: string }): Promise<{ data: Interview }> {
...
export async function updateInterviewStatus(id: string, status: InterviewStatus, feedback?: string, rating?: number): Promise<{ data: Interview }> {
  ...
  mockInterviews[idx] = { ...mockInterviews[idx], status, feedback: feedback ?? mockInterviews[idx].feedback, rating: rating ?? mockInterviews[idx].rating };
  return { data: mockInterviews[idx] };
}

// ── Offers ──

export async function fetchOffers(filters?: { search?: string; status?: string; skip?: number; take?: number }): Promise<{ data: Offer[]; total: number; skip: number; take: number }> {
  let filtered = [...mockOffers];
  if (filters?.search) {
    const s = filters.search.toLowerCase();
    filtered = filtered.filter((o) => o.candidateName.toLowerCase().includes(s) || o.position.toLowerCase().includes(s));
  }
...
export async function createOffer(body: { candidateId: string; candidateName: string; position: string; salary: number; currency?: string; notes?: string }): Promise<{ data: Offer }> {
...
export async function updateOfferStatus(id: string, status: OfferStatus): Promise<{ data: Offer }> {
  const idx = mockOffers.findIndex((o) => o.id === id);
  if (idx === -1) throw new Error("Offer not found");
  mockOffers[idx].status = status;
  if (status === "SENT") mockOffers[idx].sentDate = new Date().toISOString().split("T")[0];
  if (status === "ACCEPTED" || status === "REJECTED") mockOffers[idx].responseDate = new Date().toISOString().split("T")[0];
  return { data: mockOffers[idx] };
}
...
export async function fetchRecruitmentFunnel(): Promise<{ data: RecruitmentFunnelData[] }> {
  ...
  const data = stages.map((stage) => ({
    stage,
    count: mockCandidates.filter((c) => c.currentStage === stage || (stage === "REJECTED" && c.status === "REJECTED")).length,
  }));
  return { data };
}
...
export async function fetchTimeToHire(): Promise<{ data: TimeToHireData[] }> {
  return {
    data: [
      { month: "Jan", days: 28 }, { month: "Feb", days: 25 }, { month: "Mar", days: 30 },
      { month: "Apr", days: 22 }, { month: "May", days: 26 }, { month: "Jun", days: 20 },
    ],
  };
}
...
export async function fetchOfferAcceptanceRate(): Promise<{ data: number }> {
  ...
  const sent = mockOffers.filter((o) => o.status === "SENT" || o.status === "ACCEPTED" || o.status === "REJECTED").length;
  return { data: sent > 0 ? Math.round((accepted / sent) * 100) : 0 };
}

export async function fetchHiringByDepartment(): Promise<{ data: DepartmentHireData[] }> {
  const deptMap = new Map<string, number>();
  mockOffers.filter((o) => o.status === "ACCEPTED").forEach((o) => {
    const dept = o.position.includes("Engineer") ? "Engineering" : o.position.includes("Manager") ? "Human Resources" : o.position.includes("Designer") ? "Design" : o.position.includes("Analyst") ? "Data" : "Marketing";
    deptMap.set(dept, (deptMap.get(dept) ?? 0) + 1);
  });
  return { data: Array.from(deptMap.entries()).map(([department, hires]) => ({ department, hires })) };
}
  ...
  return {
    data: [
      ...
      { month: "Apr", applications: 60, interviews: 18, offers: 5 },
      { month: "May", applications: 55, interviews: 14, offers: 4 },
      { month: "Jun", applications: 42, interviews: 11, offers: 3 },
    ],
  };
}

...
export default function CompliancePage() {
  ...
  return (
    <div className="p-6 space-y-5">
      ...
      {activeTab === 2 && <ContributionRatesTable country={country} />}
      {activeTab === 3 && <TaxSlabTable country={country} />}
      {activeTab === 4 && <ComplianceDocumentUpload country={country} addToast={addToast} />}
    </div>
  );
}
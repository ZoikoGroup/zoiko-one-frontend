      ...
      {loading ? (
        ...
        <section className="overflow-hidden rounded-[28px] border border-slate-800 bg-[#0b1220] shadow-[0_20px_80px_rgba(0,0,0,0.35)]">
          <div className="border-b border-slate-800 px-5 py-4">
            <h2 className="text-lg font-semibold text-white">Certifications <span className="ml-2 text-sm font-normal text-slate-400">({total})</span></h2>
          </div>
            ...
            <table className="w-full min-w-[800px] border-collapse text-left text-sm">
              ...
              <tbody className="divide-y divide-slate-800">
                {certifications.length === 0 ? (
                  <tr>
                    <td colSpan={5} className="px-5 py-8 text-center text-sm text-slate-500">No certifications found.</td>
                  </tr>
                ) : (
                  certifications.map((c) => (
                    <tr key={c.id} className="transition duration-200 hover:bg-slate-900/80">
                      ...
                      <td className="px-5 py-4 text-slate-400">{c.certification}</td>
                      <td className="px-5 py-4 text-slate-400">{c.issueDate}</td>
                      <td className="px-5 py-4 text-slate-400">{c.expiryDate}</td>

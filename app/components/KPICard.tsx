  ...
  return (
    <article className="rounded-[24px] border border-slate-800 bg-slate-950 p-5 shadow-[0_20px_60px_rgba(0,0,0,0.4)]">
      <div className="flex items-start justify-between gap-4">
        ...
        {Icon ? (
          <span className="flex h-12 w-12 items-center justify-center rounded-3xl bg-[#141d2f] text-slate-200">
      ...
      <div className="mt-5 flex flex-wrap items-center gap-2 text-sm text-slate-400">
        ...
        {trend ? <span className="rounded-full bg-emerald-500/10 px-3 py-1 text-emerald-300">{trend}</span> : null}
      </div>
    </article>
  );
}

...
const CATEGORY_OPTIONS = ["Hardware", "Software", "Furniture", "Electronics", "Vehicle", "Other"];
                    ...
                    <tr key={a.id} className="hover:bg-amber-50/50 transition-colors">
                      ...
                      <td className="px-4 py-3 text-right">
                        <div className="flex items-center justify-end gap-2">
                          <button onClick={() => openEdit(a)} className="p-1 text-gray-400 hover:text-amber-600 transition-colors" title="Edit">&#9998;</button>
                          <button onClick={() => handleDelete(a.id)} className="p-1 text-gray-400 hover:text-red-600 transition-colors" title="Delete">&#10005;</button>
                        </div>
                      </td>
                    </tr>
                  );

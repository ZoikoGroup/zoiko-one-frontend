...
import { useAudits } from "../hooks/useComply";
...
export default function Audits() {
  const { audits, findings, summary, loading } = useAudits();
  ...
  if (selectedAudit) {
    ...
    return (
      <div className="space-y-6">
        <button onClick={() => setSelectedAudit(null)} className="text-sm text-gray-500 hover:text-gray-700 flex items-center gap-1">
          ← Back to Audits
        </button>
